...
vcftools_PATH1 <- system("which vcftools", intern = T)
vcftools_PATH2 <- "/path/to/vcftools0.1.12_or_higher/"
#example: vcftools_PATH2 <- "/home/evan/miniconda2/bin/"

vcf_export <- paste("export PATH=", vcftools_PATH, "/:$PATH;", sep = "")
version <-system(paste(vcf_export,'vcftools'), intern=T)[2]
if(grepl("0.1.11", version)) {
     assign("vcftools_path_export",vcftools_PATH2)
     stop("Please update vcftools to v0.1.12 or later, and/or edit vcf_PATH above")
   } else {assign("vcftools_path_export",vcftools_PATH1)
