...
source("scripts/cessPOOL/cessPOOL_preAnalysis.R")
source("scripts/cessPOOL/cessPOOL_syncSetup.R")
source("scripts/cessPOOL/cessPOOL_postPopoolation.R")
source("scripts/cessPOOL/cessPOOL_poolHeatmaps.R")
working_dir <- here()
```
...
Ensure the following files are located in the working directory:
  ...
  * \*.bam        | *BAM file used for poPoolation pileup*
