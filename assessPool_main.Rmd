...
vcflib_PATH <- tryCatch({
    system('vcffilter', intern=T)
    return("")
  }, error = function(e){ 
    vcflib_PATH <- paste(working_dir, "scripts", "vcflib", "bin", sep="/")
...
if(grepl("0.1.11", version)) {
     ...
     message("Please update vcftools to v0.1.12 or later, and/or edit vcf_PATH above")
   } else {
