...
#Path to vcftools v0.1.12 or higher - uncomment and edit if warned below, then re-run code chunk
#vcftools_PATH <- "export PATH=<PATH_TO_VCFTOOLS_0.1.12_or_later>:$PATH;"
#example:
#vcftools_PATH <- " export PATH=/home/evan/miniconda2/bin/:$PATH;"

#determine vcftools version
version <-system(paste(vcftools_path_export,'vcftools', sep=""), intern=T)[2]
...
vcftools_path_export <- paste("export PATH=", vcftools_path_export, ":$PATH;", sep = "")
