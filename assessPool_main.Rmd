...
ggplot(data=filter_df) + geom_bar(aes(x=Filter_f, y=SNPs), stat="identity") + theme_bw() + theme(axis.text.x = element_text(angle = -70, hjust=-0.1), plot.title = element_text(hjust = 0.5)) + ggtitle("Number of SNPs after each filter")
